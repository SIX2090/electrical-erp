...
def ensure_pre_schema_compatibility(cur) -> None:
    statements = [
        ...
        "ALTER TABLE IF EXISTS inventory_transactions ADD COLUMN IF NOT EXISTS serial_no VARCHAR(120)",
...
def ensure_finance_compatibility_columns(cur) -> None:
    exec_many(
        ...
        [
            ...
            "ALTER TABLE IF EXISTS inventory_costing ADD COLUMN IF NOT EXISTS serial_no VARCHAR(120)",
            ...
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS product_id INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS product_code VARCHAR(120)",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS product_name VARCHAR(255)",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS cost_object_id INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS period_year INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS period_month INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS cost_category VARCHAR(50)",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS source_id INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS source_line_id INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS debit_amount NUMERIC(18,2) DEFAULT 0",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS credit_amount NUMERIC(18,2) DEFAULT 0",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS balance_amount NUMERIC(18,2) DEFAULT 0",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS cost_amount NUMERIC(14,2) DEFAULT 0",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS unit_cost NUMERIC(14,4)",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS unit VARCHAR(20)",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS material_code VARCHAR(120)",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS material_name VARCHAR(255)",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS supplier_id INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS supplier_name VARCHAR(255)",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS work_order_id INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS work_order_no VARCHAR(120)",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS department_id INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS employee_id INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS voucher_no VARCHAR(120)",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS voucher_id INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS is_posted BOOLEAN DEFAULT FALSE",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS created_by INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS updated_by INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS recorded_by INTEGER",
            "ALTER TABLE IF EXISTS serial_cost_ledger ADD COLUMN IF NOT EXISTS recorded_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP",
...
def apply_finance_file_migrations(cur) -> None:
    ...
    if migration_006:
        ...
        if (
            ...
            and columns_present(cur, "serial_cost_ledger", ("serial_no", "cost_date", "cost_amount"))
