...
ERP_OPERATION_MANUAL = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "机床项目按项目号和柜号追踪；它们是追溯字段，不是所有场景都强制填写。",
    ...
    },
    {
        ...
        "steps": [
            "从项目/柜号台账查看工程准备度，先确认项目号、柜号和销售订单来源。",
            "缺少技术确认时，从台账进入新增技术确认单，系统会带入销售订单、产品、项目号、柜号和图纸版本。",
            "技术确认单保存前要校验 BOM、图纸、工艺路线和工作中心，确认后下游才能作为 MRP、齐套和工单依据。",
            "如果工程准备未就绪，按阻塞原因分派给技术/工艺或计划/采购处理，再回到项目/柜号台账复核。",
        ],
        "links": [
            {"label": "技术确认单", "href": "/engineering/technical-confirmations"},
            {"label": "齐套检查", "href": "/engineering/kitting"},
            {"label": "项目/柜号台账", "href": "/projects"},
            {"label": "工程准备预警API", "href": "/api/project-machine-ledger/engineering-readiness/alerts"},
        ],
        "tips": [
            "项目/柜号台账是只读追溯入口，不在台账里直接创建采购、库存或生产单据。",
            "AI助手可以按项目号、柜号或销售订单号读取工程准备上下文，但不会自动确认技术资料。",
        ],
    },
    {
        "key": "purchase",
        ...
        "steps": [
            ...
            "到货时从采购订单生成收货或入库，核对物料、数量、仓库和项目柜号。",
    ...
    },
    {
        "key": "sales",
        "title": "销售业务",
        "summary": "销售订单驱动发货、应收、项目号和柜号追溯。",
        "steps": [
            "录入销售订单时确认客户、交期、项目号、柜号和明细物料。",
            "订单提交审核后，进入待发货队列或待处理单据。",
            "发货时核对库存、仓库、批次、柜号和未发数量。",
        ...
        "tips": ["项目号和柜号要贯穿销售、库存、生产、服务和财务报表。"],
    },
    {
        "key": "inventory",
        "title": "库存业务",
    ...
    },
    {
        "key": "production",
        "title": "生产业务",
        "summary": "工单围绕 BOM、领料、完工入库和项目柜号闭环。",
        "steps": [
            "建工单前确认物料、BOM、工艺路线和项目柜号。",
    ...
    },
    {
        "key": "service",
        "title": "售后服务",
        "summary": "售后按柜号建立服务卡、服务单、RMA和费用成本追踪。",
        "steps": [
            "按柜号查询服务卡，确认客户、项目号、出厂和安装信息。",
            "服务单记录现场问题、处理过程、费用和责任归属。",
            "RMA 处理要关联柜号、物料、退回、维修和索赔。",
...
TOPIC_KEYWORDS = [
    ("engineering_readiness", ("工程准备", "技术确认", "图纸", "项目号", "柜号", "齐套", "BOM", "工艺路线")),
