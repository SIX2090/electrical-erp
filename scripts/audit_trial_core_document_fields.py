...
PAGES = {
    ...
    "/inventory/inbound": ("其他入库", "单据信息", "来源单据", "项目号", "物料明细", "库存成本单价", "批号", "机号"),
    "/inventory/outbound": ("其他出库", "单据信息", "来源单据", "项目号", "物料明细", "库存成本单价", "批号", "机号"),
    "/transfers/new": ("库存调拨单", "调出仓库", "调入仓库", "项目号", "调拨明细", "库存成本单价", "批号", "机号"),
    "/adjustments/new": ("库存调整单", "调整类型", "项目号", "调整明细", "库存成本单价", "批号", "机号"),
    "/inventory_checks/new": ("库存盘点单", "盘点日期", "项目号", "盘点明细", "实盘数量", "库存成本单价", "批号", "机号"),
}
