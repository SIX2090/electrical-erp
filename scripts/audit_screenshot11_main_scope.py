...
def main():
    ...
    checks.append(check("home_role_queue_boundary", "试点队列" in index and "项目/柜号风险" in index and "业务单据" not in index.split("{% if nav_mode")[1].split("{% else %}")[0], "home pilot area is queue/workbench oriented"))
