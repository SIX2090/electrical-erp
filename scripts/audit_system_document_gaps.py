...
LINE_FIELDS = {
    ...
    "cabinet_no": ("data-column-key=\"cabinet_no\"", "柜号", "cabinet_no"),
...
DOCUMENTS = (
    DocumentSpec("Sales", "Sales order / shipment base", "templates/order_form.html", "templates/sales_order_list.html", "templates/document_trace_detail.html", "_save_sales_order", ("material_code", "material_name", "specification", "unit", "quantity", "price_or_cost", "amount", "lot_no", "cabinet_no", "project_code", "source_line"), ("partner", "document_no", "date", "project_code", "cabinet_no", "warehouse", "status", "remark"), ("submit", "approve", "close", "cancel_or_void", "print", "attachments", "notes")),
    DocumentSpec("Purchase", "Purchase order", "templates/order_form.html", "templates/purchase_order_list.html", "templates/document_trace_detail.html", "_save_purchase_order", ("material_code", "material_name", "specification", "unit", "quantity", "price_or_cost", "amount", "lot_no", "cabinet_no", "project_code", "source_line"), ("partner", "document_no", "date", "project_code", "cabinet_no", "warehouse", "status", "remark"), ("submit", "approve", "close", "cancel_or_void", "print", "attachments", "notes")),
    DocumentSpec("Purchase", "Purchase request", "templates/purchase_request_add.html", "templates/purchase_request.html", "templates/purchase_request_detail.html", None, ("material_code", "material_name", "specification", "unit", "quantity", "price_or_cost", "amount", "warehouse", "location", "lot_no", "cabinet_no", "project_code", "source_line"), ("document_no", "date", "project_code", "cabinet_no", "status", "remark"), ("submit", "approve", "close", "cancel_or_void", "print", "attachments", "notes")),
    DocumentSpec("Inventory", "Other inbound / other outbound", "templates/inventory_movement_form.html", "templates/simple_list.html", "templates/inventory_document_detail.html", "_create_inventory_movement", ("material_code", "material_name", "specification", "unit", "quantity", "price_or_cost", "amount", "warehouse", "location", "lot_no", "cabinet_no", "project_code", "source_line"), ("document_no", "date", "project_code", "cabinet_no", "warehouse", "location", "source_doc", "status", "remark"), ("post", "close", "cancel_or_void", "print", "attachments", "notes")),
    DocumentSpec("Inventory", "Inventory adjustment", "templates/inventory_adjustment_form.html", "templates/simple_list.html", "templates/inventory_document_detail.html", "_create_inventory_adjustment", ("material_code", "material_name", "specification", "unit", "quantity", "price_or_cost", "amount", "warehouse", "location", "lot_no", "cabinet_no", "project_code", "source_line"), ("document_no", "date", "project_code", "warehouse", "location", "status", "remark"), ("post", "close", "cancel_or_void", "print", "attachments", "notes")),
    DocumentSpec("Inventory", "Inventory transfer", "templates/inventory_transfer_form.html", "templates/simple_list.html", "templates/inventory_document_detail.html", "_create_inventory_transfer", ("material_code", "material_name", "specification", "unit", "quantity", "price_or_cost", "amount", "warehouse", "location", "lot_no", "cabinet_no", "project_code", "source_line"), ("document_no", "date", "project_code", "warehouse", "location", "status", "remark"), ("post", "close", "cancel_or_void", "print", "attachments", "notes")),
    DocumentSpec("Inventory", "Inventory check", "templates/inventory_check_form.html", "templates/simple_list.html", "templates/inventory_document_detail.html", "_create_inventory_check", ("material_code", "material_name", "specification", "unit", "quantity", "price_or_cost", "amount", "warehouse", "location", "lot_no", "cabinet_no", "project_code", "source_line"), ("document_no", "date", "project_code", "warehouse", "location", "status", "remark"), ("post", "close", "cancel_or_void", "print", "attachments", "notes")),
    DocumentSpec("Inventory", "Assembly / disassembly", "templates/inventory_assembly_form.html", "templates/simple_list.html", "templates/inventory_assembly_detail.html", "_create_inventory_assembly_document", ("material_code", "material_name", "specification", "unit", "quantity", "price_or_cost", "amount", "warehouse", "location", "lot_no", "cabinet_no", "project_code", "source_line"), ("document_no", "date", "project_code", "cabinet_no", "warehouse", "location", "status", "remark"), ("post", "close", "cancel_or_void", "print", "attachments", "notes")),
    DocumentSpec("Outsourcing", "Subcontract order", "templates/subcontract_order_form.html", "templates/subcontract.html", "templates/subcontract_detail.html", "_save_subcontract_order", ("material_code", "material_name", "specification", "unit", "quantity", "price_or_cost", "amount", "warehouse", "location", "lot_no", "cabinet_no", "project_code", "source_line"), ("partner", "document_no", "date", "project_code", "cabinet_no", "status", "remark"), ("submit", "approve", "close", "cancel_or_void", "print", "attachments", "notes")),
    DocumentSpec("Production", "Work order", "templates/work_order_form.html", "templates/work_order_requisition.html", "templates/work_order_trace_detail.html", "_save_work_order", ("material_code", "material_name", "specification", "unit", "quantity", "price_or_cost", "amount", "warehouse", "location", "lot_no", "cabinet_no", "project_code", "source_line"), ("document_no", "date", "project_code", "cabinet_no", "warehouse", "status", "remark"), ("submit", "approve", "close", "cancel_or_void", "print", "attachments", "notes")),
    DocumentSpec("Service", "Service order part issue", "templates/service_order_trace_detail.html", None, "templates/service_order_trace_detail.html", "_issue_service_order_part", ("material_code", "material_name", "specification", "unit", "quantity", "price_or_cost", "amount", "warehouse", "location", "lot_no", "cabinet_no", "project_code", "source_line"), ("partner", "document_no", "date", "project_code", "cabinet_no", "status", "remark"), ("close", "print", "attachments", "notes")),
    DocumentSpec("Service", "RMA", None, None, "templates/service_rma_trace_detail.html", "_create_rma_from_service_order", ("material_code", "material_name", "specification", "unit", "quantity", "price_or_cost", "amount", "warehouse", "location", "lot_no", "cabinet_no", "project_code", "source_line"), ("partner", "document_no", "date", "project_code", "cabinet_no", "status", "remark", "source_doc"), ("close", "attachments", "notes")),
    DocumentSpec("Finance", "Receivable / payable", None, None, "templates/finance_trace_detail.html", None, ("amount", "project_code", "source_line"), ("partner", "document_no", "date", "project_code", "cabinet_no", "status", "remark", "source_doc"), ("close", "attachments", "notes")),
)
...
def risk_level(line_ui: list[str], line_save: list[str], header_ui: list[str], ops: list[str], dirty: int) -> str:
    if not line_ui and not line_save and not header_ui and not ops and not dirty:
        return "ok"
    critical_fields = {"material_code", "specification", "unit", "quantity", "price_or_cost", "amount", "warehouse", "location", "cabinet_no", "project_code", "source_line"}
