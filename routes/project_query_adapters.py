...
def project_kit_rows_adapter(order_id, project_code, serial_no, cost_object_id, safe_rows):
...
def project_finance_summary_adapter(order, project_code, serial_no, cost_object_id, safe_one, as_decimal):
