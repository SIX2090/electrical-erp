...
REPORT_SECTIONS = {
    "sales": {
        ...
        "sections": [
            ...
            ("/sales/reports/summary", "销售汇总表", ["客户", "项目号", "柜号", "销售含税金额", "未交金额"]),
            ("/sales/reports/order-execution-detail", "销售订单执行明细", ["订单数量", "已发货", "未发货", "已开票", "未收款"]),
            ("/sales/reports/order-execution-summary", "销售订单执行汇总", ["客户", "项目号", "柜号", "订单金额", "发货金额"]),
            ("/sales/reports/project-cabinet-order-tracking", "项目/柜号销售订单跟踪", ["项目号", "柜号", "订单", "发货", "收款"]),
            ...
            ("/sales/reports/project-cabinet-open-order-analysis", "项目/柜号未交订单分析", ["项目号", "柜号", "未交数量", "交付风险"]),
            ("/sales/reports/invoice-execution-detail", "销售开票执行明细", ["销售订单", "发货单", "应开票", "已开票"]),
            ("/sales/reports/invoice-summary", "销售发票汇总表", ["客户", "项目号", "柜号", "含税金额", "税额"]),
            ("/sales/reports/receivable-collection-detail", "销售收款执行明细", ["客户", "订单", "应收", "已收", "逾期"]),
            ("/sales/reports/receivable-aging", "销售应收账龄分析", ["客户", "项目号", "柜号", "账龄余额"]),
            ("/sales/reports/project-cabinet-gross-margin", "项目/柜号销售毛利分析", ["销售收入", "发货成本", "毛利", "毛利率"]),
    ...
    "purchase": {
        ...
        "sections": [
            ...
            ("/purchase/reports/summary", "采购汇总表", ["供应商", "项目号", "柜号", "采购含税金额", "未到金额"]),
            ...
            ("/purchase/reports/order-execution-summary", "采购订单执行汇总", ["供应商", "项目号", "柜号", "含税金额"]),
            ("/purchase/reports/receipt-tracking", "采购到货跟踪", ["交期", "已收货", "逾期未到"]),
            ("/purchase/reports/receipt-detail", "采购入库明细", ["收货单", "仓库", "批次", "项目号", "柜号"]),
            ("/purchase/reports/receipt-summary", "采购入库汇总", ["供应商", "物料", "仓库", "收货金额"]),
            ("/purchase/reports/received-not-invoiced-detail", "收货未开票明细", ["已收货", "未开票", "账龄"]),
            ("/purchase/reports/received-not-invoiced-summary", "收货未开票汇总", ["供应商", "项目号", "柜号", "未开票余额"]),
            ("/purchase/reports/invoice-detail", "采购发票明细表", ["供应商", "来源单据", "项目号", "柜号", "含税金额"]),
            ("/purchase/reports/invoice-summary", "采购发票汇总表", ["供应商", "项目号", "柜号", "含税金额", "税额"]),
            ...
            ("/purchase/reports/project-cabinet-purchase-cost-detail", "项目/柜号采购成本明细", ["采购订单", "收货", "应付金额"]),
    ...
    "inventory": {
        "title": "库存报表",
        "sections": [
            ("/inventory/reports/ledger", "标准库存明细账", ["物料", "仓库", "库位", "批号", "柜号", "项目号", "入库", "出库", "结存"]),
            ...
            ("/inventory/reports/location-stock", "库位库存表", ["仓库", "库位", "物料", "批号", "柜号", "数量"]),
            ...
            ("/inventory/reports/project-occupation", "项目/柜号库存占用表", ["项目号", "柜号", "库存数量", "库存金额"]),
            ("/inventory/reports/check-difference", "盘点差异汇总表", ["盘点单", "盘盈", "盘亏", "金额"]),
            ("/inventory/reports/fund-occupation", "库存资金占用表", ["库存金额", "单位成本", "项目号", "柜号"]),
            ("/inventory/reports/batch-trace", "批次/柜号追溯表", ["批号", "柜号", "项目号", "库存余额", "流水"]),
            ...
            ("/inventory/reports/project-cabinet-cost", "项目/柜号库存成本表", ["项目号", "柜号", "领用金额", "结存金额"]),
    ...
    "production": {
        ...
        "sections": [
            ...
            ("/production/reports/bom-reverse-query", "BOM 子件反查", ["子件物料", "父项物料", "项目号", "柜号"]),
            ("/production/reports/bom-cost-query", "BOM 成本查询", ["物料", "标准用量", "单位成本", "标准成本"]),
            ("/production/reports/work-order-detail", "生产工单明细", ["工单", "项目号", "柜号", "状态"]),
            ("/production/reports/work-order-execution-detail", "生产工单执行明细", ["计划数", "领料数", "报工数", "完工数"]),
            ("/production/reports/work-order-execution-summary", "生产工单执行汇总", ["项目号", "柜号", "在制", "完工", "延期"]),
            ("/production/reports/work-order-statistics", "生产任务单统计表", ["产品", "项目号", "柜号", "计划数量", "完成数量"]),
            ("/production/reports/project-cabinet-progress", "项目/柜号生产进度跟踪", ["销售订单", "BOM", "工单", "领料", "入库"]),
            ...
            ("/production/reports/material-issue-summary", "工单领料汇总", ["工单", "项目号", "柜号", "材料金额"]),
            ...
            ("/production/reports/completion-inbound-detail", "完工入库明细", ["工单", "产品", "项目号", "柜号", "仓库"]),
            ...
            ("/production/reports/quality-exception-summary", "质量异常汇总", ["项目号", "柜号", "工序", "异常率"]),
            ...
            ("/production/reports/project-cabinet-production-cost", "项目/柜号生产成本明细", ["工单成本", "委外成本", "报废损失"]),
    ...
    "subcontract": {
        ...
        "sections": [
            ...
            ("/subcontract/reports/order-execution-summary", "委外订单执行汇总", ["加工商", "项目号", "柜号", "未回数量"]),
            ("/subcontract/reports/issue-detail", "委外发料明细", ["发料单", "物料", "批次", "项目号", "柜号"]),
            ...
            ("/subcontract/reports/project-cabinet-progress-tracking", "项目/柜号委外进度跟踪", ["项目号", "柜号", "发料", "收货", "应付"]),
            ("/subcontract/reports/project-cabinet-cost-detail", "项目/柜号委外成本明细", ["加工费", "材料成本", "短收报废损失"]),
            ...
            ("/inventory/reports/subcontract-inout-detail", "委外收发明细报表", ["日期", "来源单据", "发出", "收回", "项目号", "柜号"]),
    ...
    "finance": {
        ...
        "sections": [
            ...
            ("/finance/reports/receivable-summary", "应收账款汇总表", ["客户", "项目号", "柜号", "应收金额", "余额"]),
            ...
            ("/finance/reports/receivable-execution-summary", "应收执行汇总", ["客户", "项目号", "柜号", "未收余额"]),
            ("/finance/reports/receivable-aging", "应收账龄分析", ["客户", "项目号", "柜号", "账龄"]),
            ...
            ("/finance/reports/payable-summary", "应付账款汇总表", ["供应商", "项目号", "柜号", "应付金额", "余额"]),
            ("/finance/reports/payable-detail", "应付账款明细表", ["来源单据", "供应商", "应付金额", "已付金额", "余额"]),
            ("/finance/reports/payment-request-statistics", "付款申请统计表", ["供应商", "项目号", "柜号", "申请金额", "未付余额"]),
            ...
            ("/finance/reports/payable-execution-summary", "应付执行汇总", ["供应商", "项目号", "柜号", "未付余额"]),
            ("/finance/reports/payable-aging", "应付账龄分析", ["供应商", "项目号", "柜号", "账龄"]),
            ...
            ("/finance/reports/statement-history", "历史对账单", ["往来单位", "收付款单", "核销金额", "项目号", "柜号"]),
            ...
            ("/finance/inventory-cost/summary", "库存成本总账", ["库存余额", "单位成本", "库存金额", "项目号", "柜号"]),
            ...
            ("/finance/reports/machine-cost", "柜号成本明细", ["柜号", "材料", "委外", "生产", "售后"]),
            ("/finance/reports/cabinet-cost-summary", "柜号成本汇总", ["柜号", "收入", "成本", "毛利"]),
            ("/finance/reports/project-cabinet-margin-analysis", "项目/柜号毛利分析", ["销售收入", "成本", "毛利率"]),
